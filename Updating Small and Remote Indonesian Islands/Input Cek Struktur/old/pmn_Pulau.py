...
#exit()
with open('Pemilikan_Pulau.csv') as csv_file:
                   ...
                   # pmnID
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    arcpy.CalculateField_management(output, "pmnObjName", "[STATUS]", "VB", "")
                                except arcpy.ExecuteError, error:
                                    try:
                                        arcpy.CalculateField_management(output, "pmnObjName", "[Status]", "VB", "")
                                    except arcpy.ExecuteError, error:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print "2"
                            try:
                                arcpy.CalculateField_management(output, "pmnID", "[M_KODE]", "VB", "")
                            except arcpy.ExecuteError, error:
                                print "3"
                                try:
                                    arcpy.CalculateField_management(output, "pmnID", "[STATUS_TAN]", "VB", "")
                                except arcpy.ExecuteError, error:
                                    print "3"
                                    try:
                                        arcpy.CalculateField_management(output, "pmnID", "[Status_Tan]", "VB", "")
                                        ...
                                        try:
                                            ...
                                            print "5"
                                            try:
                                                arcpy.CalculateField_management(output, "pmnID", "[Status_Tnh]", "VB", "")
                                            except arcpy.ExecuteError, error:
                                                print "6"
                                                try:
                                                    arcpy.CalculateField_management(output, "pmnID", "[Status_TNH]", "VB", "")
                                                    ...
                                                    try:
                                                        ...
                                                        print "8"
                                                        try:
                                                            arcpy.CalculateField_management(output, "pmnID", "[ST_TNH]", "VB", "")
                                                        except arcpy.ExecuteError, error:
                                                            print "9"
                                                            try:
                                                                arcpy.CalculateField_management(output, "pmnID", "[TANAH]", "VB", "")
                                                            except arcpy.ExecuteError, error:
                                                                print "10"
                                                                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    arcpy.CalculateField_management(output, "pmnRemarks", "[KET]", "VB", "")
                                except arcpy.ExecuteError, error:
                                    try:
                                        arcpy.CalculateField_management(output, "pmnRemarks", "[Ket]", "VB", "")
                                    except arcpy.ExecuteError, error:
